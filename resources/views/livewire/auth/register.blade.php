<form class="space-y-6" wire:submit.prevent="register">
    <!-- Name Field -->
    <x-ui.input label='Name' name='name' type='text' placeholder='Input your name' wireModel='name' />

    <!-- Email Field -->
    <x-ui.input label='Email Email Address' name='email' type='email' placeholder='Input your email address'
        wireModel='email' />
    ...
    <!-- Password Field -->
    <x-ui.input_password label='Confirm Password' name='password_confirmation' data='showConfirmPassword'
        placeholder='Enter your confirm password' wireModel='password_confirmation' />

    <!-- Submit Button -->
    <div>
        <x-ui.button_primary :label="'Sign up to ' . config('app.name')" type='submit' wireTarget='register'>
            <x-slot name="icon">
                <svg wire:loading.remove wire:target='register' class="w-5 h-5 mr-2" fill="none"
